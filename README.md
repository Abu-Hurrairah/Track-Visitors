...
This project is intended for academic and demonstration purposes. For production use, additional work is required in security, and deployment configuration.
